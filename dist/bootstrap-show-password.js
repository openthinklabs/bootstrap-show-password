(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('core-js/modules/es.parse-int.js'), require('core-js/modules/es.regexp.exec.js'), require('core-js/modules/es.string.replace.js'), require('core-js/modules/es.array.join.js'), require('core-js/modules/es.array.concat.js'), require('core-js/modules/es.array.includes.js'), require('core-js/modules/es.function.name.js'), require('core-js/modules/es.array.index-of.js'), require('core-js/modules/es.array.find.js'), require('core-js/modules/es.object.to-string.js'), require('jquery')) :
  typeof define === 'function' && define.amd ? define(['core-js/modules/es.parse-int.js', 'core-js/modules/es.regexp.exec.js', 'core-js/modules/es.string.replace.js', 'core-js/modules/es.array.join.js', 'core-js/modules/es.array.concat.js', 'core-js/modules/es.array.includes.js', 'core-js/modules/es.function.name.js', 'core-js/modules/es.array.index-of.js', 'core-js/modules/es.array.find.js', 'core-js/modules/es.object.to-string.js', 'jquery'], factory) :
  (global = global || self, factory(null, null, null, null, null, null, null, null, null, null, global.jQuery));
}(this, (function (es_parseInt_js, es_regexp_exec_js, es_string_replace_js, es_array_join_js, es_array_concat_js, es_array_includes_js, es_function_name_js, es_array_indexOf_js, es_array_find_js, es_object_toString_js, $) { 'use strict';
